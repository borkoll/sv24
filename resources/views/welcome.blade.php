...
@section('title', 'Свалка 24 главная страница')
...
@section('content')
    <header class="text-center" name="home">
        <div class="intro-text">
            <h1 class="wow fadeInDown">Мы-<strong><span class="color">СВАЛКА В СПБ</span></strong></h1>
            <p class="wow fadeInDown">НЕ ВЫКИДЫВАЙТЕ СТАРЫЕ ВЕЩИ-ПОМОГАЙТЕ ЛЮДЯМ И ПЛАНЕТЕ</p>
            <a href="/request" class="btn btn-default btn-lg page-scroll wow fadeInUp" data-wow-delay="200ms">Сдать ненужные вещи</a> </div>
    </header>
